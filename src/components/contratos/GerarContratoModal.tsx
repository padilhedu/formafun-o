      ...
      <div className="card" style={{ width: 480, maxWidth: '95vw', padding: 28 }}>
        ...
        {loadingTemplates ? (
          ...
          <>
              ...
              <div className="space-y-2">
                {templates.map(t => (
                  <label
                    ...
                    style={{
                      border: `1px solid ${selectedTemplate === t.id ? 'rgba(31,122,77,0.4)' : 'rgba(0,0,0,0.08)'}`,
            ...
            {error && (
              <p style={{ fontSize: 12, color: '#C0392B', fontFamily: 'var(--font-montserrat)', marginBottom: 12 }}>{error}</p>
            )}
