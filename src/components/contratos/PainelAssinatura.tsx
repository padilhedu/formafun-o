    ...
    <div>
      ...
      {(status === 'enviado' || status === 'visualizado') && signUrl && (
        <div>
          <div style={{ ...cardStyle, border: '1px solid rgba(96,165,250,0.2)' }}>
            ...
            {expStr && (
              <p style={{ fontSize: 11, color: '#FBBF24', fontFamily: 'var(--font-montserrat)', marginTop: 4 }}>
          ...
          {confirmNewLink ? (
            <div style={{ ...cardStyle, border: '1px solid rgba(251,191,36,0.3)' }}>
              <p style={{ fontSize: 13, color: '#FBBF24', fontFamily: 'var(--font-montserrat)', marginBottom: 10 }}>
      ...
      {status === 'assinado' && (
        <div>
          <div style={{ ...cardStyle, border: '1px solid rgba(74,222,128,0.25)', background: 'rgba(74,222,128,0.04)' }}>
            <span style={{ fontSize: 12, padding: '3px 10px', borderRadius: 5, background: 'rgba(74,222,128,0.12)', color: '#4ADE80', fontFamily: 'var(--font-montserrat)', fontWeight: 600, display: 'inline-block', marginBottom: 12 }}>
      ...
      {status === 'recusado' && (
        <div style={{ ...cardStyle, border: '1px solid rgba(248,113,113,0.25)' }}>
          <span style={{ fontSize: 12, padding: '3px 10px', borderRadius: 5, background: 'rgba(248,113,113,0.1)', color: '#F87171', fontFamily: 'var(--font-montserrat)', fontWeight: 600, display: 'inline-block', marginBottom: 10 }}>
            Contrato recusado
          </span>
          {c.recusado_em && (
      ...
      {erro && (
        <div style={{ marginTop: 10, padding: '10px 14px', borderRadius: 8, background: 'rgba(248,113,113,0.08)', border: '1px solid rgba(248,113,113,0.25)', color: '#F87171', fontSize: 13, fontFamily: 'var(--font-montserrat)' }}>
          {erro}
        </div>
      )}
    </div>
