                            ...
                            <div style={{
                              ...
                              {[
                                ...
                                <button
                                  ...
                                  style={{ width: '100%', textAlign: 'left', padding: '9px 14px', background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: '#1C1C1C', fontFamily: 'var(--font-montserrat)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, width: 520, maxWidth: '95vw', maxHeight: '80vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '12px 20px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
              <input
                ...
                style={{ width: '100%', background: '#FFFFFF', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 8, padding: '8px 12px', color: '#1C1C1C', fontSize: 13, fontFamily: 'var(--font-montserrat)', outline: 'none' }}
