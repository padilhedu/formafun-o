    ...
    <div>
      ...
      <div style={cardStyle}>
        <div style={{ padding: '11px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)' }}>
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.05em', color: '#D9C9A3', fontFamily: 'var(--font-montserrat)', textTransform: 'uppercase' }}>
            Serviços
          </span>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {servicosDisponiveis.map(proc => {
              ...
              return (
                <tr key={proc.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', background: noOrc ? 'rgba(184,154,90,0.04)' : 'transparent' }}>
                  <td style={{ padding: '9px 12px', fontSize: 13, color: '#F5F2EA', fontFamily: 'var(--font-montserrat)' }}>
                    {proc.nome}
                    {noOrc && <span style={{ marginLeft: 8, fontSize: 10, color: '#4ADE80', fontWeight: 700 }}>✓ incluído</span>}
                  </td>
                  <td style={{ padding: '9px 12px', fontSize: 13, color: '#8A8A93', fontFamily: 'var(--font-montserrat)' }}>
                    ...
                    <td style={{ padding: '9px 12px', textAlign: 'center' }}>
                      {noOrc ? (
                        ...
                        <button
                          ...
                          style={{ background: 'rgba(184,154,90,0.1)', border: '1px solid rgba(184,154,90,0.25)', color: '#B89A5A', borderRadius: 6, padding: '4px 12px', fontSize: 11, cursor: 'pointer', fontFamily: 'var(--font-montserrat)' }}
