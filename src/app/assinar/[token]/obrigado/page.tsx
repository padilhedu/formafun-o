      ...
      <div style={{ width: '100%', maxWidth: 440, background: '#121214', borderRadius: 20, padding: 36, border: '1px solid rgba(74,222,128,0.25)', marginTop: 60, textAlign: 'center' }}>
        ...
        {c && (
          <a
            ...
            style={{ display: 'block', width: '100%', padding: '14px', borderRadius: 10, background: '#1F7A4D', color: '#0A0A0B', fontWeight: 700, fontSize: 15, textDecoration: 'none', fontFamily: 'var(--font-montserrat,sans-serif)', boxSizing: 'border-box' }}
          >
            Baixar PDF agora
          </a>
        )}
