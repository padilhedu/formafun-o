...
export default async function RecusadoPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F3EF', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      ...
      <div style={{ width: '100%', maxWidth: 440, background: '#FFFFFF', borderRadius: 20, padding: 36, border: '1px solid rgba(248,113,113,0.25)', marginTop: 60, textAlign: 'center' }}>
        <div style={{ width: 64, height: 64, borderRadius: '50%', background: 'rgba(248,113,113,0.1)', border: '2px solid rgba(248,113,113,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="#C0392B" strokeWidth="2.5"><path d="M7 7l14 14M21 7L7 21" strokeLinecap="round"/></svg>
        </div>
        <h1 style={{ fontFamily: 'var(--font-cormorant,serif)', fontSize: 26, color: '#C0392B', margin: '0 0 12px', fontWeight: 600 }}>
          Contrato recusado
        </h1>
        <p style={{ fontSize: 14, color: '#6B6B66', fontFamily: 'var(--font-montserrat,sans-serif)', lineHeight: 1.6, marginBottom: 24 }}>
        ...
        {(clinica.telefone || clinica.email) && (
          <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 10, padding: '12px 16px', border: '1px solid rgba(0,0,0,0.08)' }}>
