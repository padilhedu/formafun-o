      ...
      <div className="grid grid-cols-[220px_1fr] gap-6" style={{ minHeight: 600 }}>
        ...
        {selected ? (
          <div className="space-y-4">
            {/* Meta fields */}
            <div style={{ borderRadius: 12, background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.08)', padding: 16 }}>
            ...
            {/* Placeholders */}
            <div style={{ borderRadius: 12, background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.08)', padding: 14 }}>
            ...
            {preview ? (
              <div style={{ borderRadius: 12, background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.08)', padding: 0, overflow: 'hidden' }}>
                <iframe
                  srcDoc={editHtml}
          ...
          <div style={{ borderRadius: 14, background: '#FFFFFF', border: '1px dashed rgba(31,122,77,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
